...
function punto_fijo_multivariable_sucesiva(funcion_g1,funcion_g2,valor_tanteado_x,valor_tanteado_y,margen_error,cantidad_iteraciones);
    ...
    if(criterio_x<1&&criterio_y<1)
        ...
        fprintf("Los criterio de convergencia (%f,%f) son mayores que 1, por ende, con lo valores entregados, la funcion nunca va a poder converger",criterio_x,criterio_y);
    end
