function aprox_pol_newt_finita_hacia_delante_por_consola()
    clc
    [n,valor_de_x,factor_h,vector_valores_fx, valor_buscado_x,f_valor_real,bandera] = obtenerDatosXConsola_por_numero_datos_de_x_lineal();
    
    if(bandera)
        %Se halla la matriz de diferencias divididas;
        [matriz_diferencias_lineal_divididas,grado,vector_valores_x]= diferencias_linenal_divididas_hacia_delante(n,valor_de_x,factor_h,vector_valores_fx);
