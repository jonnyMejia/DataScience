function [vector_resultados_final]=resolucion_por_metodo_de_crout(sistema_ecuaciones, simbolos,vector_resultados)
    clc;
    disp ("=========Resolucion por el metodo de crout=========");
    fprintf("\n");
    ...
    [Matriz_L,Matriz_U] = Descomposicion_L_U_Crout(Matriz_de_coeficientes);
